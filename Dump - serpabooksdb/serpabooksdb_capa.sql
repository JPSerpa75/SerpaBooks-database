...
CREATE TABLE `capa` (
  ...
  `ds_capa` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id_capa`)
...
INSERT INTO `capa` VALUES (12,'Capa comum'),(13,'Capa dura'),(14,'Acessório'),(15,'Capa flexível'),(16,'Canoa, Grampeado ou Costurado'),(17,'eBook Kindle'),(18,'Livro cartonado'),(19,'Livro (capa Tankobon)');
